...
function configContent(options: InitOptions): string {
...
function workflowContent(options: InitOptions): string {
...
export function createInitPlan(options: InitOptions): InitPlanEntry[] {
  const root = path.resolve(options.root);
  const planned: InitPlanEntry[] = [
    {
...
export async function writeInitPlan(options: InitOptions): Promise<InitWriteResult> {
